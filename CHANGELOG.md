...
|---------|------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| 1.7.0   | 2026.06.21 | Added `Policy.RuleLines()` display helper (splits `Rules` into `[]string`, one line per entry, for table/log/JSON display); `Rules` itself remains the canonical `string` document, unchanged |
